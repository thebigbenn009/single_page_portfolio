  ...
  return (
    <Wrapper>
        <section className='header'>
            <div className='left'>
                <h6>mazalee</h6>
                <h3>Nice to meet you!<br/>I'm <span>Mazalee</span>.</h3>
                <p>Based in Nigeria, I'm a frontend developer<br/> passionate about building accessible web <br/>apps that users love</p>
